...
{
    { .pin = (PinName)P68, .gpio_type = eGPIO_INPUT_PULL_UP },    //ACK_HW_PIN_HOST_INTERRUPT
    { .pin = (PinName)P69, .gpio_type = eGPIO_OUTPUT_PUSH_PULL }, //ACK_HW_PIN_MODULE_RESET
};
const int i32BoardMaxGPIONum  = sizeof(g_asBoardGpioDev) / sizeof(g_asBoardGpioDev[0]);

S_GPIODev g_asBoardUserGpioDev [] =
{
    { .pin = (PinName)P38,    .gpio_type = eGPIO_OUTPUT_PUSH_PULL }, //Alexa-connected indictor
    { .pin = (PinName)P43,       .gpio_type = eGPIO_INPUT_PULL_UP }, //Restor factory setting?
};
