...
S_GPIODev g_asBoardGpioDev [] =
{
    ...
    { .pin = (PinName)D9, .gpio_type = eGPIO_OUTPUT_PUSH_PULL }, //ACK_HW_PIN_SAMPLE_APPLICATIONS_LED
#endif
#ifdef ACK_SAMPLE_APPLICATIONS_GPIO_PIN_1
    { .pin = (PinName)D8, .gpio_type = eGPIO_OUTPUT_PUSH_PULL }, //ACK_HW_PIN_SAMPLE_APPLICATIONS_LED
#endif
#ifdef ACK_SAMPLE_APPLICATIONS_GPIO_PIN_2
    { .pin = (PinName)D7, .gpio_type = eGPIO_OUTPUT_PUSH_PULL }, //ACK_HW_PIN_SAMPLE_APPLICATIONS_LED
#endif
#ifdef ACK_SAMPLE_APPLICATIONS_GPIO_PIN_3
    { .pin = (PinName)D6, .gpio_type = eGPIO_OUTPUT_PUSH_PULL }, //ACK_HW_PIN_SAMPLE_APPLICATIONS_LED
#endif
};
