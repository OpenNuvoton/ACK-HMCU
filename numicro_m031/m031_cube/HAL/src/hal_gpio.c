...
{
    {{NULL}, GPIO_PAPBPGPH_IRQn, 0},
    {{NULL}, GPIO_PAPBPGPH_IRQn, 1},
    {{NULL}, GPIO_PCPDPEPF_IRQn, 2},
    {{NULL}, GPIO_PCPDPEPF_IRQn, 3},
    {{NULL}, GPIO_PCPDPEPF_IRQn, 4},
    {{NULL}, GPIO_PCPDPEPF_IRQn, 5},
    {{NULL}, GPIO_PAPBPGPH_IRQn, 6},
    {{NULL}, GPIO_PAPBPGPH_IRQn, 7},
};
...
{
    numicro_gpio_irq(&gpio_irq_var_arr[6]);    // 72: GPIO Port G
}
void GPH_IRQHandler(void)
{
    numicro_gpio_irq(&gpio_irq_var_arr[7]);    // 88: GPIO Port H
}
