...
const S_PDMA_Peripheral_Ctl sPDMAPeripheralCtl[ ] =
{
    ...
    { PDMA_UART6_TX, PDMA_SAR_INC, PDMA_DAR_FIX },
    { PDMA_UART7_TX, PDMA_SAR_INC, PDMA_DAR_FIX },
    ...
    { PDMA_UART6_RX, PDMA_SAR_FIX, PDMA_DAR_INC },
    { PDMA_UART7_RX, PDMA_SAR_FIX, PDMA_DAR_INC },
    { 0 }
};
