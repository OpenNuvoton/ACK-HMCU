...
{
    { .pin = (PinName)P39, .gpio_type = eGPIO_INPUT_PULL_UP },    //ACK_HW_PIN_HOST_INTERRUPT
    { .pin = (PinName)P40, .gpio_type = eGPIO_OUTPUT_PUSH_PULL }, //ACK_HW_PIN_MODULE_RESET
};
const int i32BoardMaxGPIONum  = sizeof(g_asBoardGpioDev) / sizeof(g_asBoardGpioDev[0]);

S_GPIODev g_asBoardUserGpioDev [] =
{
    { .pin = (PinName)P27,    .gpio_type = eGPIO_OUTPUT_PUSH_PULL }, //Alexa-connected indictor
    { .pin = (PinName)P23,       .gpio_type = eGPIO_INPUT_PULL_UP }, //Restor factory setting?
};
